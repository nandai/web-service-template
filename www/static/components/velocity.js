...
(function ()
{
    ...
    *********************/
    ...
    var Type =
    {
        ...
        /* Determine if variable is a wrapped jQuery element. */
        isWrapped: function (variable)
        {
            return variable && (variable.jquery);
        },
    ...
    **************/
    ...
    function getEasing(value, duration)
    {
        ...
        if (easing === false)
        {
            if (Velocity.Easings[Velocity.defaults.easing]) easing = Velocity.defaults.easing;
            else                                            easing = EASING_DEFAULT;
        }
    ...
    var CSS = Velocity.CSS =
    {
            ...
            *****************************/
            ...
            register: function ()
            {
                ...
                *****************/
                ...
                /* Note: Android Gingerbread have support for 2D -- but not 3D -- transforms. Since animating unsupported
        ...
        ****************************/
        ...
        flushTransformCache: function(element)
        {
            ...
            if ((Velocity.State.isAndroid && !Velocity.State.isChrome) && Data(element).isSVG)
            {
    ...
    var animate = function()
    {
        ...
        ******************/
        ...
        function getChain()
        {
            ...
            {
                /* Otherwise, if we're using $.fn, return the jQuery-wrapped element set. */
        ...
        *************************/
        ...
        /* Whether Velocity was called via the utility function (as opposed to on a jQuery object). */
        var isUtility;
        ...
        /* Detect jQuery elements being animated via the $.fn method. */
        ...
        ***************/
        ...
        /* If this call was made via the utility function (which is the default method of invocation when jQuery are not being used), and if
                    ...
                    ***************************/
                    ...
                    for (var property in propertiesMap)
                    {
                        ...
                        **************************/
                        ...
                        /* If the display option is being set to a non-"none" (e.g. "block") and opacity is being
...
//              } catch (error) {
//                  NOTE;こんなところで例外処理されると本来のエラー発生個所が分からなくなるのでコメント化！
//                  setTimeout(function() { throw error; }, 1);
//              }
            }
